...
#ifdef COLDEND32
unsigned int    adc_resolution = 4095;
#endif
#ifdef MKS_GENL
unsigned int    adc_resolution = 1023;
#endif
float           exp_scale = log(MAX_RPM/MIN_RPM)/adc_resolution;  // Exponential flow scaling to match a 12bit analogue value
